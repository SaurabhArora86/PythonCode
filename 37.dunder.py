...
class Employee:
    def __init__(self, name):  # This is a constructor, it is called automatically when object is created
        self.name = name
...
print(c1)  # This will invoke __str__ method
print(str(c1))  # This will invoke __str__ method
